...
public:
	...
	Player(const char* name)
	{
		...
		strcpy_s(this->name, length, name); // 문자열 복사, null 문자 포함
...
int main()
{
	...
	// 문자열
	//const wchar_t* wName = L"Minsung"; // wide 문자열 리터럴, const wchar_t* 타입
	...
	*/
	...
	// Wide Character
	const wchar_t* wcName = L"Minsung"; // wide 문자열 리터럴, const wchar_t* 타입

	//Windows 타입
	//WCHAR

	//STL 문자열 타입.
	std::string nameString = "Minsung"; // std::string 타입, 문자열 리터럴로 초기화
	std::cout << nameString << "\n"; // std::string 출력
	std::cout << "nameString length: " << nameString.size() << "\n"; // std::string 길이 출력
	//std::wstring wNameString = L"Minsung"; // std::wstring 타입, wide 문자열 리터럴로 초기화

	//std::string을 C-Raw string으로 변환
	const char* rawName = nameString.c_str(); // std::string을 C 스타일 문자열로 변환																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																					
